...
read vnum
rsync -e 'ssh -p 2222' /Users/arjun/Dropbox/CurriculumVitae/AD-resume_v${vnum}.pdf adhanjal@backend.arjundhanjal.com:~/landfill/.CV/AD-resume_v${vnum}.pdf
ssh adhanjal@backend.arjundhanjal.com -p 2222 "cd landfill/ ; ln -fs .CV/AD-resume_v${vnum}.pdf AD-resume_current.pdf"
